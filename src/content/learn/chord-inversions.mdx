...
<ChordEmbed chords="C G Am F" bpm={90} style="pop_basic" title="I–V–vi–IV in root position" />

This sounds good. But every chord jump produces an abrupt bass leap: C moves to G (up a fifth), G moves to A (up a second), A moves to F (down a third). The bass line zigzags. With inversions, you can smooth that out.
...
The bass descends C → B → A → G one step at a time while the chord changes minimally on top. You hear this in dozens of famous songs.

<ChordEmbed chords="C Am F G" bpm={85} style="folk_strum" title="Progression suited to descending bass line" />
...
<ChordEmbed chords="C G Am Em F C F G" bpm={90} style="pop_basic" title="Full eight-chord pop progression" />

Take a progression like this one. By inserting G/B between G and Am, and Am/G before F, you turn the leaping bass line into a smooth descending scale. Same chords, completely different feel.
