...
export const GENRES: Genre[] = [
  {
    ...
    progressions: [
      { title: 'I–V–VI–IV (The Axis)', chords: 'C G Am F', bpm: 110, style: 'pop_1', description: 'The most recorded progression in modern pop. Heard in hundreds of hits.' },
      { title: 'VI–IV–I–V', chords: 'Am F C G', bpm: 100, style: 'pop_1', description: 'Same chords as the Axis, but starting on VI gives a more melancholic feel.' },
      { title: 'I–IV–V', chords: 'C F G', bpm: 120, style: 'pop_1', description: 'Three-chord foundation of pop, rock, and folk.' },
      { title: 'I–V–VI–III–IV', chords: 'C G Am Em F', bpm: 105, style: 'pop_1', description: 'Five-chord variation adding the III for extra harmonic color.' },
      { title: 'I–IV–VI–V', chords: 'C F Am G', bpm: 108, style: 'pop_1', description: 'Builds tension through the IV before resolving on V.' },
      { title: 'I–VI–IV–V (50s Progression)', chords: 'C Am F G', bpm: 115, style: 'pop_1', description: 'Classic doo-wop and early rock staple. Romantic and timeless.' },
    ],
  },
  {
    slug: 'jazz',
    ...
    progressions: [
      { title: 'II–V–I', chords: 'Dm7 G7 Cmaj7', bpm: 120, style: 'pop_1', description: 'The cornerstone of jazz harmony. Used in virtually every jazz standard ever written.' },
      { title: 'I–VI–II–V (Turnaround)', chords: 'Cmaj7 A7 Dm7 G7', bpm: 130, style: 'pop_1', description: 'Classic jazz turnaround used to loop back to the top of any standard.' },
      { title: 'II–V–I–VI (Extended)', chords: 'Dm7 G7 Cmaj7 A7', bpm: 120, style: 'pop_1', description: 'Extends the II–V–I with a VI7 that pulls the ear back to the beginning.' },
      { title: 'III–VI–II–V (Cycle)', chords: 'Em7 A7 Dm7 G7', bpm: 140, style: 'pop_1', description: 'A cycle-of-fifths chain of dominants. The backbone of bebop harmony.' },
      { title: 'Jazz Blues', chords: 'C7 F7 C7 G7 F7 C7', bpm: 120, style: 'pop_1', description: 'The 12-bar blues with jazz seventh chords. Parker, Rollins, Coltrane all started here.' },
      { title: 'Bossa Nova Loop', chords: 'Cmaj7 Am7 Dm7 G7', bpm: 80, style: 'pop_1', description: 'Jobim-style major seventh harmony at a relaxed bossa nova tempo.' },
      { title: 'Descending Bossa Nova', chords: 'Fmaj7 Em7 Am7 Dm7 G7 Cmaj7', bpm: 75, style: 'pop_1', description: 'Flowing cycle-of-fifths movement — the classic Jobim sound.' },
      { title: 'Minor II–V–I', chords: 'Dm7 G7 Cm7', bpm: 120, style: 'pop_1', description: 'The minor key II–V–I. Essential for Autumn Leaves, Summertime, and minor standards.' },
      { title: 'Dorian Modal Vamp', chords: 'Dm7 Em7 Fmaj7 Em7', bpm: 110, style: 'pop_1', description: 'Miles Davis "So What" style modal jazz. Two chords, infinite space.' },
      { title: 'Cycle of Fifths', chords: 'Em7 A7 Dm7 G7 Cmaj7', bpm: 130, style: 'pop_1', description: 'Descending through the circle of fifths. The skeleton of Autumn Leaves.' },
      { title: 'I–IV–III–VI (Bird Blues)', chords: 'Cmaj7 Fmaj7 Em7 A7', bpm: 130, style: 'pop_1', description: 'Charlie Parker style reharmonization — Bird Blues opening changes.' },
      { title: 'Neo Soul Jazz', chords: 'Dm9 G13 Cmaj9 Am9', bpm: 88, style: 'pop_1', description: 'Extended ninth and thirteenth chords for a modern jazz-R&B crossover feel.' },
    ],
  },
  {
    slug: 'lo-fi',
    ...
    progressions: [
      { title: 'Lo-fi Jazz Loop', chords: 'Cmaj7 Am7 Fmaj7 G7', bpm: 75, style: 'pop_1', description: 'Warm extended chords at a relaxed tempo. Perfect for study beats.' },
      { title: 'Chill Minor', chords: 'Am7 Dm7 G7 Cmaj7', bpm: 80, style: 'pop_1', description: 'Smooth minor-to-major journey. Melancholic but calming.' },
      { title: 'Study Vibes', chords: 'Fmaj7 Em7 Am7 Dm7', bpm: 70, style: 'pop_1', description: 'Four flowing major seventh chords. Great for focus and concentration.' },
      { title: 'Rainy Day', chords: 'Cmaj7 Bm7 Em7 Am7', bpm: 72, style: 'pop_1', description: 'Descending motion with rich seventh harmony.' },
    ],
  },
  {
    slug: 'sad',
    ...
    progressions: [
      { title: 'Minor I–VI–III–VII', chords: 'Am F C G', bpm: 70, style: 'pop_1', description: 'Classic melancholic pop. Starts in minor, resolves to relative major.' },
      { title: 'I–IV–V', chords: 'Am Dm Em', bpm: 65, style: 'pop_1', description: 'Pure minor three-chord sadness. Raw and exposed.' },
      { title: 'I–VI–IV–V', chords: 'Am F Dm E', bpm: 75, style: 'pop_1', description: 'Deep emotional pull with the IV chord adding extra weight.' },
      { title: 'Descending Minor', chords: 'Am G F E', bpm: 72, style: 'pop_1', description: 'Falling bass line creates mounting tension and sadness.' },
      { title: 'I–VII–VI–V', chords: 'Am G F Em', bpm: 68, style: 'pop_1', description: 'Slow descending line. Works well at half tempo for ballads.' },
    ],
  },
  {
    slug: 'happy',
    ...
    editorialQA: [
      {
        ...
        answer: 'They <strong>stay in major keys</strong> — the major third is acoustically stable, so the ear reads it as bright and resolved.',
      },
      {
        question: 'What\'s the oldest happy progression in Western music?',
        answer: 'I–IV–V–I. It powers folk, hymns, and rock and roll by following the simplest harmonic logic: leave, build tension, return.',
      },
      {
        question: 'Can a "happy" progression include a minor chord?',
        answer: 'Yes — I–III–IV–V borrows the minor III chord for unexpected color, without breaking the upbeat, major-key feel.',
      },
      {
        question: 'Why does the III chord (Em in C) sound happy but slightly wistful?',
        answer: 'It shares two notes with the I chord, but its minor quality adds warmth without tipping into real melancholy.',
      },
      {
        question: 'Does tempo change how "happy" a progression feels?',
        answer: 'Yes — the same four chords sound anthemic at 135 BPM and pastoral at 120 BPM. Try both below.',
      },
      {
        question: 'How would you turn this happy progression into a sad one?',
        answer: 'Same shape, minor key: swap C–F–G–C for Am–Dm–Em–Am. Same logic, completely different, more melancholic mood.',
      },
    ],
    ...
    progressions: [
      { title: 'I–IV–V–I', chords: 'C F G C', bpm: 130, style: 'pop_1', description: 'Classic uplifting major progression. Instantly recognizable.' },
      { title: 'I–II–IV–I', chords: 'C Dm F C', bpm: 125, style: 'pop_1', description: 'Bright and bouncy with a soft II chord in the middle.' },
      { title: 'I–V–IV–V', chords: 'G D C D', bpm: 135, style: 'pop_1', description: 'High energy shuffle feel. Great for anthems and feel-good pop.' },
      { title: 'I–III–IV–V', chords: 'C Em F G', bpm: 120, style: 'pop_1', description: 'The III chord adds warmth before the IV resolution.' },
    ],
  },
  {
    slug: 'neo-soul',
  ...
  },
  {
    ...
    progressions: [
      { title: 'Club Classic', chords: 'Am F C G', bpm: 128, style: 'pop_1', description: 'The universal EDM minor progression. Works in every subgenre.' },
      { title: 'Trance Loop', chords: 'Am G F E', bpm: 140, style: 'pop_1', description: 'Descending bass line with mounting intensity.' },
      { title: 'Progressive House', chords: 'C G Am F', bpm: 130, style: 'pop_1', description: 'Classic build-and-drop structure for progressive tracks.' },
      { title: 'Euphoric Rave', chords: 'F C G Am', bpm: 138, style: 'pop_1', description: 'Starts on IV for an instant emotional lift.' },
    ],
  },
  {
    slug: 'rock',
    ...
    progressions: [
      { title: 'I–IV–V (Classic Rock)', chords: 'E A B', bpm: 120, style: 'pop_1', description: 'The three-chord foundation of rock and roll. Chuck Berry, Johnny B. Goode, and a thousand others.' },
      { title: 'I–V–IV–V (Driving Anthem)', chords: 'G D C D', bpm: 130, style: 'pop_1', description: 'Starting on the dominant creates immediate forward momentum. Works at any rock tempo.' },
      { title: 'I–VII–VI–VII (Minor Rock)', chords: 'Am G F G', bpm: 120, style: 'pop_1', description: 'Natural minor with a raised VII creates the classic rock anthem feel.' },
      { title: 'I–IV–I–V (Power Ballad)', chords: 'Am Dm Am E', bpm: 75, style: 'pop_1', description: 'Slow minor progression with strong V resolution. Perfect for power ballads.' },
      { title: 'I–IV–II–V (Blues-Rock)', chords: 'E A B7 B7', bpm: 110, style: 'pop_1', description: 'Blues-influenced movement with a dominant seventh tension on V.' },
      { title: 'I–VI–III–VII (Arena Rock)', chords: 'Am F C G', bpm: 125, style: 'pop_1', description: 'The relative major escape — dark but anthemic. Heard in decades of arena rock.' },
    ],
  },
  {
    slug: 'blues',
    ...
    progressions: [
      { title: '12-Bar Blues (E major)', chords: 'E7 E7 E7 E7 A7 A7 E7 E7 B7 A7 E7 B7', bpm: 120, style: 'pop_1', description: 'The classic 12-bar blues in E. The most recorded chord progression in American music.', scale: { root: 4, scaleName: 'Blues Minor Scale', label: 'E Blues Scale' } },
      { title: '12-Bar Blues with Quick Change', chords: 'E7 A7 E7 E7 A7 A7 E7 E7 B7 A7 E7 B7', bpm: 120, style: 'pop_1', description: 'Jumps to IV in bar 2 for extra momentum. Standard in Chicago blues.', scale: { root: 4, scaleName: 'Blues Minor Scale', label: 'E Blues Scale' } },
      { title: 'Slow Blues (C major)', chords: 'C7 F7 C7 G7 F7 C7', bpm: 60, style: 'pop_1', description: 'Half-time feel at a slow tempo. Every note counts — leave space between the chords.', scale: { root: 0, scaleName: 'Blues Minor Scale', label: 'C Blues Scale' } },
      { title: 'Minor Blues', chords: 'Am7 Dm7 Am7 Em7 Dm7 Am7', bpm: 90, style: 'pop_1', description: 'The ache of the blues in a minor key. B.B. King, Clapton, and Robben Ford all live here.', scale: { root: 9, scaleName: 'Blues Minor Scale', label: 'A Blues Scale' } },
      { title: 'Blues Turnaround (I–VI–II–V)', chords: 'E7 C#7 F#7 B7', bpm: 100, style: 'pop_1', description: 'Classic turnaround used at the end of every blues chorus to set up the repeat.', scale: { root: 4, scaleName: 'Blues Minor Scale', label: 'E Blues Scale' } },
      { title: 'Gospel Blues', chords: 'G7 C7 G7 D7 C7 G7', bpm: 80, style: 'pop_1', description: 'Slower, more resolved feel. The bridge between blues and gospel harmony.', scale: { root: 7, scaleName: 'Blues Minor Scale', label: 'G Blues Scale' } },
    ],
  },
  {
    slug: '12-bar-blues',
    ...
    progressions: [
      { title: '12-Bar Blues in E (Standard)', chords: 'E7 E7 E7 E7 A7 A7 E7 E7 B7 A7 E7 B7', bpm: 120, style: 'pop_1', description: 'The definitive blues key. This exact progression appears in thousands of blues, rock, and R&B recordings.' },
      { title: '12-Bar Blues in A (Quick Change)', chords: 'A7 D7 A7 A7 D7 D7 A7 A7 E7 D7 A7 E7', bpm: 115, style: 'pop_1', description: 'Quick change to IV in bar 2. Standard Chicago blues form used by Muddy Waters and Buddy Guy.' },
      { title: '12-Bar Blues in G', chords: 'G7 G7 G7 G7 C7 C7 G7 G7 D7 C7 G7 D7', bpm: 110, style: 'pop_1', description: 'Comfortable guitar key. This is the form behind Crossroads and dozens of classic rock tracks.' },
      { title: '12-Bar Blues in C (Slow)', chords: 'C7 F7 C7 C7 F7 F7 C7 C7 G7 F7 C7 G7', bpm: 65, style: 'pop_1', description: 'At 65 BPM the blues becomes a slow burner. Every chord transition carries maximum emotional weight.' },
      { title: 'Jazz Blues (Bebop)', chords: 'C7 F7 C7 C7 F7 F7 C7 Am7 Dm7 G7 C7 G7', bpm: 130, style: 'pop_1', description: 'Charlie Parker style — substitutes Am7–Dm7–G7 in bars 8–10 for a II–V–I turnaround feel.' },
      { title: 'Minor 12-Bar Blues', chords: 'Am7 Am7 Am7 Am7 Dm7 Dm7 Am7 Am7 Em7 Dm7 Am7 Em7', bpm: 90, style: 'pop_1', description: 'The same 12-bar structure in a minor key. Darker and more introspective — the B.B. King sound.' },
    ],
  },
  {
    slug: 'ii-v-i',
    ...
    progressions: [
      { title: 'II–V–I in C major', chords: 'Dm7 G7 Cmaj7', bpm: 120, style: 'pop_1', description: 'The fundamental jazz movement. Dm7 (mild tension) → G7 (strong tension) → Cmaj7 (resolution).' },
      { title: 'II–V–I with Extensions', chords: 'Dm9 G13 Cmaj9', bpm: 115, style: 'pop_1', description: 'Same movement with ninth and thirteenth extensions. Adds color without changing the harmonic function.' },
      { title: 'Minor II–V–I (A minor)', chords: 'Bm7b5 E7 Am7', bpm: 120, style: 'pop_1', description: 'The minor key version. Bm7b5 (half-diminished) and E7 with G# create a stronger pull to Am.' },
      { title: 'II–V–I in G major', chords: 'Am7 D7 Gmaj7', bpm: 130, style: 'pop_1', description: 'Transposed to G. The same tension-resolution arc in a brighter key — standard in bebop heads.' },
      { title: 'Tritone Substitution', chords: 'Dm7 Db7 Cmaj7', bpm: 120, style: 'pop_1', description: 'Db7 replaces G7 — they share the same tritone. Creates a chromatic descending bass line D–Db–C.' },
      { title: 'Extended II–V–I Chain', chords: 'Dm7 G7 Cmaj7 A7 Dm7 G7 Cmaj7', bpm: 130, style: 'pop_1', description: 'Two II–V–I cycles linked by the VI7 (A7) turnaround. The backbone of many standard song forms.' },
    ],
  },
];
