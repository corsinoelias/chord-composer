...
export const INSTRUMENTS_LIST: InstrumentListing[] = [
  ...
  },
  {
    ...
    name: 'Piano',
    slug: 'piano',
    tagline: 'Play a virtual piano in your browser — 6 sounds, MIDI, and a song library',
    description: 'A fully playable piano with six live-synthesized sounds — acoustic and electric piano, organ, synth, strings and music box. Play with mouse, keyboard, or MIDI. Learn songs from the built-in library in Waterfall mode, or record and export as WAV or MIDI.',
    ...
    featureHighlights: [
      'Acoustic Piano, Electric Piano, Organ, Synthesizer, Strings and Music Box sounds',
