...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    defaultSound: 'finger', notes: WALKING_BASS_PRINCIPIANTE,
  ...
  },
  {
    ...
    genre: 'Jazz', bpm: 120, beatsPerBar: 4, totalBars: 4,
    defaultSound: 'finger', notes: WALKING_BASS_INTERMEDIO,
    sections: [{ name: 'Dm7 → G7 → Cmaj7', startBar: 0 }],
  },
  {
    ...
    genre: 'Jazz', bpm: 120, beatsPerBar: 4, totalBars: 4,
    defaultSound: 'finger', notes: WALKING_BASS_AVANZADO,
    sections: [{ name: 'Dm7 → G7 → Cmaj7', startBar: 0 }],
  },
  {
    ...
    genre: 'Jazz', bpm: 120, beatsPerBar: 4, totalBars: 4,
    defaultSound: 'finger', notes: WALKING_BASS_EXPERTO,
    sections: [{ name: 'Dm7 → G7 → Cmaj7', startBar: 0 }],
  },
]
